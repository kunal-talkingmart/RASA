...
## intent:addtocart
- Add to cart [Coffee & Cane Sugar Body Polish](product)
- I would like to purchase the [Buffet Experience At The Leela](product)
- I would like to buy [Day Pass To Della Adventure](product)
- Buy [Dinner At Four Points By Sheraton](product)
- Purchase [Swedish Massage](product)
- Put [Personalized Live Yoga](product) in my cart
- I'm interested in purchasing [Glass Painting](product)
- netmeds[]{"entity": "product", "value": "netmeds"}
- shoppers stop[]{"entity": "product", "value": "shoppers stop"}
- purchase Saregama Carvaan
- add to cart [escape](product) the [Tomb](product)[]{"entity": "product", "value": "escape the tomb"}

## intent:showcart
- what items do i have in my cart?
- please show me the current items i have in my cart
- what does my cart look like?
- what items do i have in my shopping cart?
- please show the current shopping cart
- what does my shopping cart look like?
- go to my cart
- show cart
- go to shopping cart
- show shopping cart
...
- [Bhopal](location)
- [Nagpur](location)
- [gift voucher]{"entity": "category", "value": "Vouchers"}
- [beauty](subcategory)
- [mumbai](location)
